# Global Research — pools.codev.id

Status: **shared family evidence foundation complete; project gates remain explicit**

Last verified: **2026-07-25 (Asia/Jakarta)**

Research family: **F10 Software, automation, domains, IoT, tools, and digital products**

Catalog covered: **12 topic families / 72 planned articles** in [`ARTICLE_CATALOG.md`](ARTICLE_CATALOG.md)

Authority boundary: [`TOPICAL_AUTHORITY.md`](TOPICAL_AUTHORITY.md)

## Purpose

This is the reusable pre-writing evidence layer for the complete `pools.codev.id` catalog. It reuses authoritative research from its broader project family, then maps that evidence to this repository's frozen topic families so related sites do not repeat the same source discovery.
...
- **Grade:** P.
- **Purpose:** Freeze the verified editorial scope for `pools.codev.id` and prevent family research from overriding this project's actual catalog boundaries.
- **Summary:** `pools.codev.id` is a member of **F10 Software, automation, domains, IoT, tools, and digital products**. Shared evidence is reused here, but its applicability is filtered through this project's topic map, application, jurisdiction, product, and installed-system gates.
...
- **Incorporation:** Use in `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
- **Incorporation:** Use in `PCD-11`, `PCD-12`. The outline must cite the original sources, keep the record's jurisdiction/product/system limits, and resolve the mapped evidence gates before definitive numeric or compliance claims.
...
| --- | --- | --- | --- |
| `PCD-01` | KR-01, KR-02, KR-03, KR-05, KR-08 | Kebutuhan dan kelayakan kolam; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-02` | KR-01, KR-02, KR-03, KR-05, KR-08 | Jenis dan fungsi kolam; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-03` | KR-01, KR-02, KR-03, KR-05, KR-08 | Desain, ukuran, dan tata letak; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-04` | KR-01, KR-02, KR-03, KR-05, KR-08 | Survei tapak dan persiapan proyek; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-05` | KR-01, KR-02, KR-03, KR-05, KR-08 | Struktur dan kedap air; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-06` | KR-01, KR-02, KR-03, KR-05, KR-08 | Finishing dan detail tepi; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-07` | KR-01, KR-02, KR-03, KR-05, KR-08 | Hidraulik, filtrasi, dan utilitas; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-08` | KR-01, KR-02, KR-03, KR-05, KR-08 | Konstruksi dan kontrol mutu; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-09` | KR-01, KR-05, KR-08, KR-10, KR-13 | Uji, serah terima, dan dokumentasi; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-10` | KR-01, KR-05, KR-08, KR-10, KR-13 | Operasi, kualitas air, dan keselamatan; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-11` | KR-01, KR-05, KR-10, KR-13, KR-15 | Perawatan dan diagnosis masalah; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
| `PCD-12` | KR-01, KR-05, KR-10, KR-13, KR-15 | Biaya, pengadaan, renovasi, dan akhir umur; use only the sourced definitions, decision inputs, system boundaries, and evidence practices in those records. | GATE-01, GATE-02, GATE-03, GATE-04, GATE-05, GATE-06, GATE-07, GATE-08, GATE-09, GATE-10, GATE-11; resolve the applicable project/product/professional evidence before exact selection, dimensions, ratings, compliance, or warranty claims. |
...
| --- | --- | --- |
| `GATE-01` project and user evidence | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | Verify users, stakeholders, current process, constraints, baseline, requirements, and acceptance ownership. |
| `GATE-02` architecture and system inventory | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | Verify the current system, data, dependencies, quality attributes, capacity/cost assumptions, alternatives, and decision records. |
| `GATE-03` security assurance | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | Obtain a versioned threat model, control mapping, secure-development evidence, and qualified verification for the exact release. |
| `GATE-04` provider API and integration facts | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | Verify current contracts, authentication, scopes, quotas, data flows, failure behavior, tests, terms, and exit path. |
| `GATE-05` Indonesian privacy and legal review | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | Verify current Indonesian and sector rules, roles, data purposes and bases, rights, vendors/transfers, retention, incidents, and qualified legal review. |
| `GATE-06` test and release evidence | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | Define release scope, environments, representative data/users, criteria, results, unresolved defects, exceptions, and decision owner. |
| `GATE-07` production and deployment evidence | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | Verify actual runtime/account configuration, provider limits, secrets, deployment, migration, cache/network behavior, rollback, and smoke tests. |
| `GATE-08` measurement and operating evidence | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | Use dated evidence with build, environment, sample, percentile, cache, tool/version, baseline, telemetry window, incident/cost context, and owner. |
| `GATE-09` commercial provider and handover evidence | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | Verify current scope, entity/team, ownership, source/accounts, competence, subcontractors, support/warranty, results, handover, and exit. |
| `GATE-10` AI and automation controls | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | Verify use-case baseline, data rights/provider handling, versioned evaluation, failure/abuse tests, human authority, monitoring, fallback, and retirement. |
| `GATE-11` family applicability correction required | `PCD-01`, `PCD-02`, `PCD-03`, `PCD-04`, `PCD-05`, `PCD-06`, `PCD-07`, `PCD-08`, `PCD-09`, `PCD-10`, `PCD-11`, `PCD-12` | This construction-and-water-safety catalog is not substantively covered by the F10 exemplar; obtain a verified pools/landscape exemplar plus structural, hydraulic, waterproofing, water-quality, safety, site, and professional evidence before outlining. |
